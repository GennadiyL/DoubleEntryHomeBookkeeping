...
/// <summary>
/// Defines the directory service.
/// Wraps platform directory operations behind the project-independent service contract.
/// Consumers resolve IDirectoryService instead of calling static Directory methods.
/// The implementation can be replaced by a test double without changing business code.
/// It does not add business-specific file-system policy.
/// </summary>
internal class DirectoryService : IDirectoryService
{
	public DirectoryInfo CreateDirectory(string path) => Directory.CreateDirectory(path);

	public DirectoryInfo CreateTempSubdirectory(string? prefix = null) => Directory.CreateTempSubdirectory(prefix);
